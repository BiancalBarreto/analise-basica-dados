/*Operadores Matematicos baseados em Funções*/
use empregados_db;
...
select nome as empregado, salario as renda, format((salario * 0.12),2) as inss, format((salario * 0.15),2) as irpr from empregado;
